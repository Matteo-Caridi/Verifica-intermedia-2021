    ...
    <body>
        ...
        <div class="container">
            <table class="table">
                ...
                <tr>
                    <th>
                        <input class="form-control" type="text" placeholder="Inserire id" name="searchId" value="<?php if (isset($_GET['searchId'])) {
                                                                                                                                    echo $_GET['searchId'];
                                                                                                                                } else {
                                                                                                                                    echo "";
                                                                                                                                } ?>">
                    ...
                    <th>
                        <input class="form-control" type="text" placeholder="Inserire nome" name="searchFirstName" value="<?php if (isset($_GET['searchFirstName'])) {
                                                                                                                                echo $_GET['searchFirstName'];
                                                                                                                            } else {
                                                                                                                                echo "";
                                                                                                                            } ?>">
                    </th>
                    ...
                    <th>
                        <input class="form-control" type="text" placeholder="Inserire cognome" name="searchLastName" value="<?php if (isset($_GET['searchLastName'])) {
                                                                                                                                echo $_GET['searchLastName'];
                                                                                                                            } else {
                                                                                                                                echo "";
                                                                                                                            } ?>">
                    </th>
                    ...
                    <th>
                        <input class="form-control" type="text" placeholder="Inserire email" name="searchMail" value="<?php if (isset($_GET['searchMail'])) {
                                                                                                                            echo $_GET['searchMail'];
                                                                                                                        } else {
                                                                                                                            echo "";
                                                                                                                        } ?>">
                    </th>
                    ...
                    <th>
                        <input class="form-control" type="text" placeholder="Inserire età" name="searchAge" value="<?php if (isset($_GET['searchAge'])) {
                                                                                                                        echo $_GET['searchAge'];
                                                                                                                    } else {
                                                                                                                        echo "";
                                                                                                                    } ?>">
